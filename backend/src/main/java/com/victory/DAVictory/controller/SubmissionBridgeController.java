...
public class SubmissionBridgeController {

    private final WritingService writingService;
    private final JwtUtil jwtUtil;

    /**
     * Bridge endpoint for writing submit using a neutral path to avoid
     * environment-specific path blocks.
     */
    @PostMapping("/text/submit")
    public ResponseEntity<?> submitTextSubmission(
