...
_RULES = [
    ...
    ("info", ["xem", "tra cuu", "kiem tra", "danh sach", "thong tin", "hoc sinh",
              "lop hoc", "de thi", "mon an", "giup", "cho toi", "hien thi",
              "tim", "tim kiem", "co the giup", "trung tam", "giao vien", "hoc vien",
              "bao nhieu lop", "bao nhieu hoc sinh", "bao nhieu giao vien",
              "bao nhieu nguoi", "co may lop", "co may hoc sinh",
              "lop nao", "hoc sinh nao", "giao vien nao",
