...
def test_calculate_overall_band_normal():
    assert calculate_overall_band([6.0, 7.0, 6.0, 6.0]) == 6.5
    assert calculate_overall_band([7.0, 7.0, 7.0, 7.0]) == 7.0
    assert calculate_overall_band([5.5, 6.0, 6.5, 6.0]) == 6.0
    assert calculate_overall_band([8.0, 8.5, 8.0, 8.5]) == 8.5
...
def test_calculate_overall_band_mixed():
    assert calculate_overall_band([6.5, 7.0]) == 7.0
    assert calculate_overall_band([5.0, 6.0, 5.0, 6.0]) == 5.5
